...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Attendance", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.BillingPlatform", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Client", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Department", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Designation", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Employee", b =>
                {
                    b.Property<long>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.EmployeeDesignation", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.EmployeeSalary", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.EmployeeSalaryStructure", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Holiday", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Incentive", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.IncentivePurpose", b =>
                {
                    b.Property<int>("IncentivePurposeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.LeaveBalance", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.LeaveMaster", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.LeaveRequest", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Project", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.TimeSheetDetail", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Timesheet", b =>
                {
                    b.Property<long>("TimesheetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.User", b =>
                {
                    b.Property<long>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Attendance", b =>
                {
                    b.HasOne("Siga_Hrms.Data.Model.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Employee", b =>
                {
                    b.HasOne("Siga_Hrms.Data.Model.Employee", "ReportingManager")
                        .WithMany()
                        .HasForeignKey("ReportingManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Siga_Hrms.Data.Model.Employee", "TeamLead")
                        .WithMany()
                        .HasForeignKey("TeamLeadId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Siga_Hrms.Data.Model.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.EmployeeDesignation", b =>
                {
                    b.HasOne("Siga_Hrms.Data.Model.Designation", "Designation")
                        .WithMany()
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Incentive", b =>
                {
                    ...
                    b.HasOne("Siga_Hrms.Data.Model.IncentivePurpose", "IncentivePurpose")
                        .WithMany()
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Project", b =>
                {
                    b.HasOne("Siga_Hrms.Data.Model.BillingPlatform", "BillingPlatform")
                        .WithMany()
                        .HasForeignKey("BillingPlatformId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Siga_Hrms.Data.Model.Client", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.TimeSheetDetail", b =>
                {
                    ...
                    b.HasOne("Siga_Hrms.Data.Model.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId");

                    b.HasOne("Siga_Hrms.Data.Model.Timesheet", "Timesheet")
                        .WithMany()
            ...
            modelBuilder.Entity("Siga_Hrms.Data.Model.Timesheet", b =>
                {
                    b.HasOne("Siga_Hrms.Data.Model.Employee", "ApproverEmployee")
                        .WithMany()
